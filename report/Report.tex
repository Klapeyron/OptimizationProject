...
\renewcommand*\contentsname{Table of contents}
	...
	\caption{The idea of pareto optimal points selected from set of feasible points}
	...
	\caption{Flow chart presenting how the second part of NPGA works (the part that is related to genetic evolution)}
